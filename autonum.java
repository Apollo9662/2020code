...
import org.firstinspires.ftc.teamcode.GyroOperator;
...
public abstract class autonum extends GyroOperator {
    ...
    public void pathRight(int red){
        ...
        pidDrive(0.4, 110, red*-43, normal,1);
        robot.horizontalElevator.setPower(0);
        robot.verticalElevator.setPower(0.1);
        sleep(1300);
        robot.verticalElevator.setPower(0);
        robot.frontClaw.setPosition(0);
        pidDrive(0.4, -28, red*-43, normal,1);
        sleep(300);
        pidDrive(0.5, -163, red*-90, normal,1);
        robot.setCollectMotorsPower(0);
        Log.d("YAIR","11");
        pidDrive(0.4, -65   , red*-180, normal,1);
        robot.initImu();
        ...
        robot.setCatchers(0);
        sleep(800);
        pidDrive(0.4, 55, red*90, normal,1);
        pidDrive(0.4, -45, red*90, normal,1);
    ...
    public void pathCenter(int red){
        ...
        pidDrive(0.3, 98, red*-31, normal,1);
        robot.horizontalElevator.setPower(0);
        robot.verticalElevator.setPower(0.1);
        sleep(1500);
        robot.verticalElevator.setPower(0);
        robot.frontClaw.setPosition(0);
        pidDrive(0.4, -23, red*-33, normal,1);
        sleep(300);
        pidDrive(0.5, -170, -90, normal,1);
        robot.setCollectMotorsPower(0);
        Log.d("YAIR","11");
        pidDrive(0.4, -65   , -180, normal,1);
        robot.initImu();
        robot.horizontalElevator.setPower(-1);
        sleep(1550);
        robot.backClaw.setPosition(0);
    ...
    public void pathLeft(int red){
        ...
        robot.frontClaw.setPosition(1);
        pidDrive(0.4, 87, red*-25, normal,1);
        robot.horizontalElevator.setPower(0);
        robot.verticalElevator.setPower(0.1);
        sleep(1300);
        robot.verticalElevator.setPower(0);
        robot.frontClaw.setPosition(0);
        pidDrive(0.4, -20, red*-25, normal,1);
        sleep(300);
        pidDrive(0.6, -162, red*-90, normal,1);
        robot.setCollectMotorsPower(0);
        Log.d("YAIR","11");
        pidDrive(0.4, -65   , red*-180, normal,1);
        robot.initImu();
